...
| -------------------- | ----------------------- | ------------------------------------ |
| `learner-context.md` | `start-course` skill    | `.claude/skills/core/start-course/references/LEARNER-CONTEXT.md` |
| `journal.md`         | `start-course` skill    | `.claude/skills/core/start-course/references/JOURNAL-TEMPLATE.md` |
