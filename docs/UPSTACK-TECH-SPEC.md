...
**Full schema reference:** `.claude/skills/create-course/references/COURSE-SCHEMA.md` — contains YAML frontmatter fields, markdown body template, directory structure, and structure rules (module/assignment/topic heading patterns).
